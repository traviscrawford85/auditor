...
T = TypeVar("T", bound="MatterLegalAidUkMatter")


@_attrs_define
class MatterLegalAidUkMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_legal_aid_uk_matter = cls(
        ...
        matter_legal_aid_uk_matter.additional_properties = d
        return matter_legal_aid_uk_matter
