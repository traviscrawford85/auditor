...
T = TypeVar("T", bound="GroupupdateFilesBody")


@_attrs_define
class GroupupdateFilesBody:
    """
    Attributes:
        data (GroupupdateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        groupupdate_files_body = cls(
            data=data,
        )

        groupupdate_files_body.additional_properties = d
        return groupupdate_files_body
