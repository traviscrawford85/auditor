...
ReportcreateJsonBodyDataKind = Literal[
    "accounts_receivable",
...
REPORTCREATE_JSON_BODY_DATA_KIND_VALUES: set[ReportcreateJsonBodyDataKind] = {
    "accounts_receivable",
    "accounts_receivable_aging",
    "bank_account_activity",
    "billing_history",
...
def check_reportcreate_json_body_data_kind(value: str) -> ReportcreateJsonBodyDataKind:
    if value in REPORTCREATE_JSON_BODY_DATA_KIND_VALUES:
        return cast(ReportcreateJsonBodyDataKind, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {REPORTCREATE_JSON_BODY_DATA_KIND_VALUES!r}")
