...
from ..models.contactupdate_files_body_data_email_addresses_item_name import (
    ...
    check_contactupdate_files_body_data_email_addresses_item_name,
)
...
class ContactupdateFilesBodyDataEmailAddressesItem:
    ...
    name: Union[Unset, ContactupdateFilesBodyDataEmailAddressesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactupdate_files_body_data_email_addresses_item_name(_name)
