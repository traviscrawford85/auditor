...
class TaskcreateFilesBodyData:
    ...
    Attributes:
        ...
        permission (Union[Unset, TaskcreateFilesBodyDataPermission]): Permission of the Task. Defaults to `public`
            Default: 'public'.
        priority (Union[Unset, TaskcreateFilesBodyDataPriority]): Priority of the Task. Default: 'Normal'.
    ...
    permission: Union[Unset, TaskcreateFilesBodyDataPermission] = "public"
    priority: Union[Unset, TaskcreateFilesBodyDataPriority] = "Normal"
    status: Union[Unset, TaskcreateFilesBodyDataStatus] = "pending"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cascading_offset_polarity, Unset):
            ...
            cascading_offset_polarity = check_taskcreate_files_body_data_cascading_offset_polarity(
        ...
        if isinstance(_cascading_offset_type, Unset):
            ...
            cascading_offset_type = check_taskcreate_files_body_data_cascading_offset_type(_cascading_offset_type)
        ...
        if isinstance(_permission, Unset):
            ...
            permission = check_taskcreate_files_body_data_permission(_permission)
        ...
        if isinstance(_priority, Unset):
            ...
            priority = check_taskcreate_files_body_data_priority(_priority)
        ...
        if isinstance(_status, Unset):
            ...
            status = check_taskcreate_files_body_data_status(_status)
