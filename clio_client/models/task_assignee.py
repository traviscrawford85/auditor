...
from ..models.participant_base_type import ParticipantBaseType, check_participant_base_type
...
T = TypeVar("T", bound="TaskAssignee")
...
class TaskAssignee:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_participant_base_type(_type_)
        ...
        task_assignee.additional_properties = d
