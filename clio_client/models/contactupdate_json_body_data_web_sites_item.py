...
from ..models.contactupdate_json_body_data_web_sites_item_name import (
    ...
    check_contactupdate_json_body_data_web_sites_item_name,
)
...
class ContactupdateJsonBodyDataWebSitesItem:
    """
    Attributes:
        name (Union[Unset, ContactupdateJsonBodyDataWebSitesItemName]): Name of the WebSite. Default: 'Other'.
        ...
        destroy (Union[Unset, bool]): The destroy flag. If the flag is set to `true` and the unique identifier of the
            associated WebSite is present, the WebSite is deleted from the Contact.
    """

    name: Union[Unset, ContactupdateJsonBodyDataWebSitesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactupdate_json_body_data_web_sites_item_name(_name)
