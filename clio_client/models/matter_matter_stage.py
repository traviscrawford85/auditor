...
T = TypeVar("T", bound="MatterMatterStage")


@_attrs_define
class MatterMatterStage:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_matter_stage.additional_properties = d
        return matter_matter_stage
