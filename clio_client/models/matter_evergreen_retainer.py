...
T = TypeVar("T", bound="MatterEvergreenRetainer")


@_attrs_define
class MatterEvergreenRetainer:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_evergreen_retainer.additional_properties = d
        return matter_evergreen_retainer
