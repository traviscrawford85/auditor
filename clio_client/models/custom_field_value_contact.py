...
T = TypeVar("T", bound="CustomFieldValueContact")


@_attrs_define
class CustomFieldValueContact:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_field_value_contact = cls(
            id=id,
            etag=etag,
            name=name,
        ...
        custom_field_value_contact.additional_properties = d
