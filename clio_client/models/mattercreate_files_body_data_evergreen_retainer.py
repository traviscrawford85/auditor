...
class MattercreateFilesBodyDataEvergreenRetainer:
    ...
    recipients: Union[Unset, list["MattercreateFilesBodyDataEvergreenRetainerRecipientsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for recipients_item_data in _recipients or []:
            recipients_item = MattercreateFilesBodyDataEvergreenRetainerRecipientsItem.from_dict(recipients_item_data)
