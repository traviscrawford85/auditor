...
from ..models.address_base_name import AddressBaseName, check_address_base_name
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactPrimaryWorkAddress")


@_attrs_define
class ContactPrimaryWorkAddress:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_address_base_name(_name)
        ...
        contact_primary_work_address = cls(
            id=id,
            etag=etag,
            street=street,
            city=city,
        ...
        contact_primary_work_address.additional_properties = d
        return contact_primary_work_address
