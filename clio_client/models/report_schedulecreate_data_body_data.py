...
class ReportSchedulecreateDataBodyData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        frequency = check_report_schedulecreate_data_body_data_frequency(d.pop("frequency"))

        report_preset_id = d.pop("report_preset_id")

        time_of_day = isoparse(d.pop("time_of_day"))

        time_zone = check_report_schedulecreate_data_body_data_time_zone(d.pop("time_zone"))
