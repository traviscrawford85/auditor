...
T = TypeVar("T", bound="DocumentCreator")
...
class DocumentCreator:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_clio_creator_base_type(_type_)
        ...
        if isinstance(_subscription_type, Unset):
            ...
            subscription_type = check_clio_creator_base_subscription_type(_subscription_type)
        ...
        document_creator.additional_properties = d
