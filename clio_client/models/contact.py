...
from ..models.contact_base_type import ContactBaseType, check_contact_base_type
...
class Contact:
    ...
    Attributes:
        ...
        primary_work_address (Union[Unset, ContactPrimaryWorkAddress]):
        primary_address (Union[Unset, ContactPrimaryAddress]):
        secondary_address (Union[Unset, ContactSecondaryAddress]):
        company (Union[Unset, ContactCompany]):
        avatar (Union[Unset, ContactAvatar]):
        payment_profile (Union[Unset, ContactPaymentProfile]):
        folder (Union[Unset, ContactFolder]):
        co_counsel_rate (Union[Unset, ContactCoCounselRate]):
        primary_web_site (Union[Unset, ContactPrimaryWebSite]):
        legal_aid_uk_contact (Union[Unset, ContactLegalAidUkContact]):
    """
    ...
    primary_work_address: Union[Unset, "ContactPrimaryWorkAddress"] = UNSET
    primary_address: Union[Unset, "ContactPrimaryAddress"] = UNSET
    secondary_address: Union[Unset, "ContactSecondaryAddress"] = UNSET
    company: Union[Unset, "ContactCompany"] = UNSET
    avatar: Union[Unset, "ContactAvatar"] = UNSET
    payment_profile: Union[Unset, "ContactPaymentProfile"] = UNSET
    folder: Union[Unset, "ContactFolder"] = UNSET
    co_counsel_rate: Union[Unset, "ContactCoCounselRate"] = UNSET
    primary_web_site: Union[Unset, "ContactPrimaryWebSite"] = UNSET
    legal_aid_uk_contact: Union[Unset, "ContactLegalAidUkContact"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_contact_base_type(_type_)
        ...
        if isinstance(_primary_work_address, Unset):
            ...
            primary_work_address = ContactPrimaryWorkAddress.from_dict(_primary_work_address)
        ...
        if isinstance(_primary_address, Unset):
            ...
            primary_address = ContactPrimaryAddress.from_dict(_primary_address)
        ...
        if isinstance(_secondary_address, Unset):
            ...
            secondary_address = ContactSecondaryAddress.from_dict(_secondary_address)
        ...
        if isinstance(_company, Unset):
            ...
            company = ContactCompany.from_dict(_company)
        ...
        if isinstance(_avatar, Unset):
            ...
            avatar = ContactAvatar.from_dict(_avatar)
        ...
        if isinstance(_payment_profile, Unset):
            ...
            payment_profile = ContactPaymentProfile.from_dict(_payment_profile)
        ...
        if isinstance(_folder, Unset):
            ...
            folder = ContactFolder.from_dict(_folder)
        ...
        if isinstance(_co_counsel_rate, Unset):
            ...
            co_counsel_rate = ContactCoCounselRate.from_dict(_co_counsel_rate)
        ...
        if isinstance(_primary_web_site, Unset):
            ...
            primary_web_site = ContactPrimaryWebSite.from_dict(_primary_web_site)
        ...
        if isinstance(_legal_aid_uk_contact, Unset):
            ...
            legal_aid_uk_contact = ContactLegalAidUkContact.from_dict(_legal_aid_uk_contact)
