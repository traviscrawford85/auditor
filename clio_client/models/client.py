...
from ..models.client_base_type import ClientBaseType, check_client_base_type
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.address_base import AddressBase
    from ..models.client_avatar import ClientAvatar
...
class Client:
    ...
    Attributes:
        ...
        avatar (Union[Unset, ClientAvatar]):
        company (Union[Unset, ClientCompany]):
    ...
    avatar: Union[Unset, "ClientAvatar"] = UNSET
    company: Union[Unset, "ClientCompany"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_client_base_type(_type_)
        ...
        if isinstance(_avatar, Unset):
            ...
            avatar = ClientAvatar.from_dict(_avatar)
        ...
        if isinstance(_company, Unset):
            ...
            company = ClientCompany.from_dict(_company)
