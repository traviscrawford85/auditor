...
T = TypeVar("T", bound="MatterResponsibleAttorney")


@_attrs_define
class MatterResponsibleAttorney:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_responsible_attorney = cls(
        ...
        matter_responsible_attorney.additional_properties = d
        return matter_responsible_attorney
