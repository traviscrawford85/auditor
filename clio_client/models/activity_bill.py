...
T = TypeVar("T", bound="ActivityBill")
...
class ActivityBill:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.available_state_transitions, Unset):
            available_state_transitions = self.available_state_transitions
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_bill_base_type(_type_)
        ...
        if isinstance(_state, Unset):
            ...
            state = check_bill_base_state(_state)
        ...
        if isinstance(_kind, Unset):
            ...
            kind = check_bill_base_kind(_kind)
        ...
        if isinstance(_available_state_transitions, Unset):
            ...
            available_state_transitions = check_bill_base_available_state_transitions(_available_state_transitions)
        ...
        activity_bill.additional_properties = d
        return activity_bill
