...
T = TypeVar("T", bound="ContactPrimaryWebSite")


@_attrs_define
class ContactPrimaryWebSite:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_web_site_base_name(_name)
        ...
        contact_primary_web_site.additional_properties = d
        return contact_primary_web_site
