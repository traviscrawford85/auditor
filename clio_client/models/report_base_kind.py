...
REPORT_BASE_KIND_VALUES: set[ReportBaseKind] = {
    "accounts_receivable",
    "accounts_receivable_aging",
    "bank_account_activity",
    "billing_history",
...
def check_report_base_kind(value: str) -> ReportBaseKind:
    if value in REPORT_BASE_KIND_VALUES:
        return cast(ReportBaseKind, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {REPORT_BASE_KIND_VALUES!r}")
