...
T = TypeVar("T", bound="ContactLegalAidUkContact")


@_attrs_define
class ContactLegalAidUkContact:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact_legal_aid_uk_contact = cls(
            id=id,
        ...
        contact_legal_aid_uk_contact.additional_properties = d
        return contact_legal_aid_uk_contact
