...
class TaskTemplateListupdateJsonBodyData:
    ...
    practice_area: Union[Unset, "TaskTemplateListupdateJsonBodyDataPracticeArea"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_practice_area, Unset):
            ...
            practice_area = TaskTemplateListupdateJsonBodyDataPracticeArea.from_dict(_practice_area)
