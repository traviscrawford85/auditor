...
T = TypeVar("T", bound="ActivityLegalAidUkActivity")


@_attrs_define
class ActivityLegalAidUkActivity:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_legal_aid_uk_activity = cls(
        ...
        activity_legal_aid_uk_activity.additional_properties = d
        return activity_legal_aid_uk_activity
