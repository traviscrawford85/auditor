...
from ..models.task_templateupdate_files_body_data_reminder_templates_item_notification_type import (
    ...
    check_task_templateupdate_files_body_data_reminder_templates_item_notification_type,
)
...
class TaskTemplateupdateFilesBodyDataReminderTemplatesItem:
    ...
    Attributes:
        ...
        destroy (Union[Unset, bool]): The destroy flag. If the flag is set to `true` and the unique identifier of the
            associated ReminderTemplate is present, the ReminderTemplate is deleted from the TaskTemplate.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_notification_type, Unset):
            ...
            notification_type = check_task_templateupdate_files_body_data_reminder_templates_item_notification_type(
                _notification_type
            )
