...
T = TypeVar("T", bound="DocumentLatestDocumentVersion")


@_attrs_define
class DocumentLatestDocumentVersion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_latest_document_version = cls(
            id=id,
        ...
        document_latest_document_version.additional_properties = d
        return document_latest_document_version
