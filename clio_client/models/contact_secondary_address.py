...
T = TypeVar("T", bound="ContactSecondaryAddress")


@_attrs_define
class ContactSecondaryAddress:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact_secondary_address.additional_properties = d
        return contact_secondary_address
