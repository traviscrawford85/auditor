...
class TaskupdateDataBodyData:
    ...
    Attributes:
        ...
        permission (Union[Unset, TaskupdateDataBodyDataPermission]): Permission of the Task. Defaults to `public`
            Default: 'public'.
        priority (Union[Unset, TaskupdateDataBodyDataPriority]): Priority of the Task. Default: 'Normal'.
    ...
    permission: Union[Unset, TaskupdateDataBodyDataPermission] = "public"
    priority: Union[Unset, TaskupdateDataBodyDataPriority] = "Normal"
    status: Union[Unset, TaskupdateDataBodyDataStatus] = "pending"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cascading_offset_polarity, Unset):
            ...
            cascading_offset_polarity = check_taskupdate_data_body_data_cascading_offset_polarity(
        ...
        if isinstance(_cascading_offset_type, Unset):
            ...
            cascading_offset_type = check_taskupdate_data_body_data_cascading_offset_type(_cascading_offset_type)
        ...
        if isinstance(_permission, Unset):
            ...
            permission = check_taskupdate_data_body_data_permission(_permission)
        ...
        if isinstance(_priority, Unset):
            ...
            priority = check_taskupdate_data_body_data_priority(_priority)
        ...
        if isinstance(_status, Unset):
            ...
            status = check_taskupdate_data_body_data_status(_status)
