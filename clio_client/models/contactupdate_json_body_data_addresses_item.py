...
from ..models.contactupdate_json_body_data_addresses_item_name import (
    ...
    check_contactupdate_json_body_data_addresses_item_name,
)
...
class ContactupdateJsonBodyDataAddressesItem:
    """
    Attributes:
        name (Union[Unset, ContactupdateJsonBodyDataAddressesItemName]): Name of the Address. Default: 'Other'.
    ...
    name: Union[Unset, ContactupdateJsonBodyDataAddressesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactupdate_json_body_data_addresses_item_name(_name)
