...
from ..models.contactcreate_files_body_data_addresses_item_name import (
    ...
    check_contactcreate_files_body_data_addresses_item_name)
...
class ContactcreateFilesBodyDataAddressesItem:
    """
    Attributes:
        name (Union[Unset, ContactcreateFilesBodyDataAddressesItemName]): Name of the Address. Default: 'Other'.
    ...
    name: Union[Unset, ContactcreateFilesBodyDataAddressesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactcreate_files_body_data_addresses_item_name(_name)
