...
class ContactcreateJsonBodyDataPhoneNumbersItem:
    """
    Attributes:
        name (Union[Unset, ContactcreateJsonBodyDataPhoneNumbersItemName]): Name of the PhoneNumber. Default: 'Other'.
    ...
    name: Union[Unset, ContactcreateJsonBodyDataPhoneNumbersItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactcreate_json_body_data_phone_numbers_item_name(_name)
