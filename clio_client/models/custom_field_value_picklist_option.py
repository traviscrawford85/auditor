...
T = TypeVar("T", bound="CustomFieldValuePicklistOption")


@_attrs_define
class CustomFieldValuePicklistOption:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_field_value_picklist_option = cls(
            id=id,
            etag=etag,
        ...
        custom_field_value_picklist_option.additional_properties = d
        return custom_field_value_picklist_option
