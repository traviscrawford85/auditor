...
class DocumentTemplateupdateJsonBodyData:
    ...
    document_category: Union[Unset, "DocumentTemplateupdateJsonBodyDataDocumentCategory"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_document_category, Unset):
            ...
            document_category = DocumentTemplateupdateJsonBodyDataDocumentCategory.from_dict(_document_category)
