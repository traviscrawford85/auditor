...
ReportPresetcreateFilesBodyDataKind = Literal[
    "accounts_receivable",
...
REPORT_PRESETCREATE_FILES_BODY_DATA_KIND_VALUES: set[ReportPresetcreateFilesBodyDataKind] = {
    "accounts_receivable",
    "accounts_receivable_aging",
    "bank_account_activity",
    "billing_history",
...
def check_report_presetcreate_files_body_data_kind(value: str) -> ReportPresetcreateFilesBodyDataKind:
    if value in REPORT_PRESETCREATE_FILES_BODY_DATA_KIND_VALUES:
        return cast(ReportPresetcreateFilesBodyDataKind, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {REPORT_PRESETCREATE_FILES_BODY_DATA_KIND_VALUES!r}")
