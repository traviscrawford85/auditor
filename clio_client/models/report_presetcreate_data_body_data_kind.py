...
ReportPresetcreateDataBodyDataKind = Literal[
    "accounts_receivable",
...
REPORT_PRESETCREATE_DATA_BODY_DATA_KIND_VALUES: set[ReportPresetcreateDataBodyDataKind] = {
    "accounts_receivable",
    "accounts_receivable_aging",
    "bank_account_activity",
    "billing_history",
...
def check_report_presetcreate_data_body_data_kind(value: str) -> ReportPresetcreateDataBodyDataKind:
    if value in REPORT_PRESETCREATE_DATA_BODY_DATA_KIND_VALUES:
        return cast(ReportPresetcreateDataBodyDataKind, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {REPORT_PRESETCREATE_DATA_BODY_DATA_KIND_VALUES!r}")
