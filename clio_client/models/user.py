...
class User:
    ...
    Attributes:
        ...
        default_activity_description (Union[Unset, UserDefaultActivityDescription]):
        notification_methods (Union[Unset, list['NotificationMethodBase']]): NotificationMethod
        account (Union[Unset, UserAccount]):
        avatar (Union[Unset, UserAvatar]):
        contact (Union[Unset, UserContact]):
        job_title (Union[Unset, UserJobTitle]):
    ...
    default_activity_description: Union[Unset, "UserDefaultActivityDescription"] = UNSET
    notification_methods: Union[Unset, list["NotificationMethodBase"]] = UNSET
    account: Union[Unset, "UserAccount"] = UNSET
    avatar: Union[Unset, "UserAvatar"] = UNSET
    contact: Union[Unset, "UserContact"] = UNSET
    job_title: Union[Unset, "UserJobTitle"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_subscription_type, Unset):
            ...
            subscription_type = check_user_base_subscription_type(_subscription_type)
        ...
        if isinstance(_default_activity_description, Unset):
            ...
            default_activity_description = UserDefaultActivityDescription.from_dict(_default_activity_description)
        ...
        if isinstance(_account, Unset):
            ...
            account = UserAccount.from_dict(_account)
        ...
        if isinstance(_contact, Unset):
            ...
            contact = UserContact.from_dict(_contact)
        ...
        if isinstance(_job_title, Unset):
            ...
            job_title = UserJobTitle.from_dict(_job_title)
