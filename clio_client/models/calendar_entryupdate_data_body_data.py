...
class CalendarEntryupdateDataBodyData:
    """
    Attributes:
        deleted (Union[Unset, CalendarEntryupdateDataBodyDataDeleted]): Flag to delete a specific instance of a
            recurring event.
    ...
    deleted: Union[Unset, CalendarEntryupdateDataBodyDataDeleted] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deleted: Union[Unset, CalendarEntryupdateDataBodyDataDeleted]
        if isinstance(_deleted, Unset):
            deleted = UNSET
        else:
            deleted = check_calendar_entryupdate_data_body_data_deleted(_deleted)
