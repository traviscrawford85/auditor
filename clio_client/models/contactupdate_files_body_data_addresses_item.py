...
from ..models.contactupdate_files_body_data_addresses_item_name import (
    ...
    check_contactupdate_files_body_data_addresses_item_name)
...
class ContactupdateFilesBodyDataAddressesItem:
    """
    Attributes:
        name (Union[Unset, ContactupdateFilesBodyDataAddressesItemName]): Name of the Address. Default: 'Other'.
        ...
        destroy (Union[Unset, bool]): The destroy flag. If the flag is set to `true` and the unique identifier of the
            associated Address is present, the Address is deleted from the Contact.
    """

    name: Union[Unset, ContactupdateFilesBodyDataAddressesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactupdate_files_body_data_addresses_item_name(_name)
