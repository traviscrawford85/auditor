...
from ..models.contactupdate_files_body_data_phone_numbers_item_name import (
    ...
    check_contactupdate_files_body_data_phone_numbers_item_name)
...
class ContactupdateFilesBodyDataPhoneNumbersItem:
    """
    Attributes:
        name (Union[Unset, ContactupdateFilesBodyDataPhoneNumbersItemName]): Name of the PhoneNumber. Default: 'Other'.
        ...
        destroy (Union[Unset, bool]): The destroy flag. If the flag is set to `true` and the unique identifier of the
            associated PhoneNumber is present, the PhoneNumber is deleted from the Contact.
    """

    name: Union[Unset, ContactupdateFilesBodyDataPhoneNumbersItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactupdate_files_body_data_phone_numbers_item_name(_name)
