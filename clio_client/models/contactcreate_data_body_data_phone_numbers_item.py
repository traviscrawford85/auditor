...
from ..models.contactcreate_data_body_data_phone_numbers_item_name import (
    ...
    check_contactcreate_data_body_data_phone_numbers_item_name,
)
...
class ContactcreateDataBodyDataPhoneNumbersItem:
    """
    Attributes:
        name (Union[Unset, ContactcreateDataBodyDataPhoneNumbersItemName]): Name of the PhoneNumber. Default: 'Other'.
    ...
    name: Union[Unset, ContactcreateDataBodyDataPhoneNumbersItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactcreate_data_body_data_phone_numbers_item_name(_name)
