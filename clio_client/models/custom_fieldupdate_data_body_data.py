...
class CustomFieldupdateDataBodyData:
    ...
    picklist_options: Union[Unset, list["CustomFieldupdateDataBodyDataPicklistOptionsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for picklist_options_item_data in _picklist_options or []:
            picklist_options_item = CustomFieldupdateDataBodyDataPicklistOptionsItem.from_dict(
