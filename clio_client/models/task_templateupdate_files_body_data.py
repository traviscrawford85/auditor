...
from ..models.task_templateupdate_files_body_data_cascading_offset_polarity import (
    ...
    check_task_templateupdate_files_body_data_cascading_offset_polarity)
from ..models.task_templateupdate_files_body_data_cascading_offset_type import (
    ...
    check_task_templateupdate_files_body_data_cascading_offset_type)
from ..models.task_templateupdate_files_body_data_priority import (
    TaskTemplateupdateFilesBodyDataPriority,
    check_task_templateupdate_files_body_data_priority)
...
class TaskTemplateupdateFilesBodyData:
    ...
    Attributes:
        ...
        priority (Union[Unset, TaskTemplateupdateFilesBodyDataPriority]): Priority of the task. Default: 'Normal'.
    ...
    priority: Union[Unset, TaskTemplateupdateFilesBodyDataPriority] = "Normal"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cascading_offset_polarity, Unset):
            ...
            cascading_offset_polarity = check_task_templateupdate_files_body_data_cascading_offset_polarity(
        ...
        if isinstance(_cascading_offset_type, Unset):
            ...
            cascading_offset_type = check_task_templateupdate_files_body_data_cascading_offset_type(
        ...
        if isinstance(_priority, Unset):
            ...
            priority = check_task_templateupdate_files_body_data_priority(_priority)
