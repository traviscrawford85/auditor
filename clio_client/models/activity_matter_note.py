...
T = TypeVar("T", bound="ActivityMatterNote")


@_attrs_define
class ActivityMatterNote:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_matter_note.additional_properties = d
        return activity_matter_note
