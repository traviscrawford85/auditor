...
T = TypeVar("T", bound="ActivityContactNote")


@_attrs_define
class ActivityContactNote:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_contact_note.additional_properties = d
        return activity_contact_note
