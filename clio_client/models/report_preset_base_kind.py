...
REPORT_PRESET_BASE_KIND_VALUES: set[ReportPresetBaseKind] = {
    "accounts_receivable",
    "accounts_receivable_aging",
    "bank_account_activity",
    "billing_history",
...
def check_report_preset_base_kind(value: str) -> ReportPresetBaseKind:
    if value in REPORT_PRESET_BASE_KIND_VALUES:
        return cast(ReportPresetBaseKind, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {REPORT_PRESET_BASE_KIND_VALUES!r}")
