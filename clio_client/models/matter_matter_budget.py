...
T = TypeVar("T", bound="MatterMatterBudget")


@_attrs_define
class MatterMatterBudget:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_matter_budget.additional_properties = d
        return matter_matter_budget
