...
T = TypeVar("T", bound="CustomFieldValueMatter")


@_attrs_define
class CustomFieldValueMatter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_field_value_matter = cls(
            id=id,
            display_number=display_number,
        )

        custom_field_value_matter.additional_properties = d
        return custom_field_value_matter
