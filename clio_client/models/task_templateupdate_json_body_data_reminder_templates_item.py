...
from ..models.task_templateupdate_json_body_data_reminder_templates_item_notification_type import (
    ...
    check_task_templateupdate_json_body_data_reminder_templates_item_notification_type,
)
...
class TaskTemplateupdateJsonBodyDataReminderTemplatesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_notification_type, Unset):
            ...
            notification_type = check_task_templateupdate_json_body_data_reminder_templates_item_notification_type(
                _notification_type
            )
