...
class CustomFieldValue:
    ...
    Attributes:
        ...
        custom_field (Union[Unset, CustomFieldValueCustomField]):
        picklist_option (Union[Unset, CustomFieldValuePicklistOption]):
        matter (Union[Unset, CustomFieldValueMatter]):
        contact (Union[Unset, CustomFieldValueContact]):
    """
    ...
    custom_field: Union[Unset, "CustomFieldValueCustomField"] = UNSET
    picklist_option: Union[Unset, "CustomFieldValuePicklistOption"] = UNSET
    matter: Union[Unset, "CustomFieldValueMatter"] = UNSET
    contact: Union[Unset, "CustomFieldValueContact"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_type, Unset):
            ...
            field_type = check_custom_field_value_base_field_type(_field_type)
        ...
        if isinstance(_custom_field, Unset):
            ...
            custom_field = CustomFieldValueCustomField.from_dict(_custom_field)
        ...
        if isinstance(_picklist_option, Unset):
            ...
            picklist_option = CustomFieldValuePicklistOption.from_dict(_picklist_option)
        ...
        if isinstance(_matter, Unset):
            ...
            matter = CustomFieldValueMatter.from_dict(_matter)
        ...
        if isinstance(_contact, Unset):
            ...
            contact = CustomFieldValueContact.from_dict(_contact)
