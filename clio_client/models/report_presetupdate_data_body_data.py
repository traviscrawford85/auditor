...
from ..models.report_presetupdate_data_body_data_format import (
    ...
    check_report_presetupdate_data_body_data_format,
)
from ..models.report_presetupdate_data_body_data_kind import (
    ReportPresetupdateDataBodyDataKind,
    check_report_presetupdate_data_body_data_kind,
)
...
class ReportPresetupdateDataBodyData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_format_, Unset):
            ...
            format_ = check_report_presetupdate_data_body_data_format(_format_)
        ...
        if isinstance(_kind, Unset):
            ...
            kind = check_report_presetupdate_data_body_data_kind(_kind)
