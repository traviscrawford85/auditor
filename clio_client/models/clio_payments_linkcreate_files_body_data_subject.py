...
@_attrs_define
class ClioPaymentsLinkcreateFilesBodyDataSubject:
    """
    Attributes:
        id (int): The ID of the record associated with the payment link.
        type_ (ClioPaymentsLinkcreateFilesBodyDataSubjectType): The type of the record associated with the payment link.
    ...
    id: int
    type_: ClioPaymentsLinkcreateFilesBodyDataSubjectType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_clio_payments_linkcreate_files_body_data_subject_type(d.pop("type"))

        clio_payments_linkcreate_files_body_data_subject = cls(
            id=id,
            type_=type_,
        )

        clio_payments_linkcreate_files_body_data_subject.additional_properties = d
        return clio_payments_linkcreate_files_body_data_subject
