...
class StatuteOfLimitationsComputeRequest:
    """
    Attributes:
        date_of_incident (datetime.date): The date when the incident occurred.
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        date_of_incident = self.date_of_incident.isoformat()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        date_of_incident = isoparse(d.pop("date_of_incident")).date()
