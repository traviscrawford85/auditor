...
from ..models.contactcreate_json_body_data_email_addresses_item_name import (
    ...
    check_contactcreate_json_body_data_email_addresses_item_name)
...
class ContactcreateJsonBodyDataEmailAddressesItem:
    ...
    name: Union[Unset, ContactcreateJsonBodyDataEmailAddressesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactcreate_json_body_data_email_addresses_item_name(_name)
