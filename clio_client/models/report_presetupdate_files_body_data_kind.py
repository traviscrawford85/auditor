...
ReportPresetupdateFilesBodyDataKind = Literal[
    "accounts_receivable",
...
REPORT_PRESETUPDATE_FILES_BODY_DATA_KIND_VALUES: set[ReportPresetupdateFilesBodyDataKind] = {
    "accounts_receivable",
    "accounts_receivable_aging",
    "bank_account_activity",
    "billing_history",
...
def check_report_presetupdate_files_body_data_kind(value: str) -> ReportPresetupdateFilesBodyDataKind:
    if value in REPORT_PRESETUPDATE_FILES_BODY_DATA_KIND_VALUES:
        return cast(ReportPresetupdateFilesBodyDataKind, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {REPORT_PRESETUPDATE_FILES_BODY_DATA_KIND_VALUES!r}")
