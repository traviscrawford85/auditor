...
T = TypeVar("T", bound="ActivityDocumentVersion")


@_attrs_define
class ActivityDocumentVersion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_document_version.additional_properties = d
        return activity_document_version
