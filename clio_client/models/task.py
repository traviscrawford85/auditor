...
if TYPE_CHECKING:
    ...
    from ..models.task_assigner import TaskAssigner
    from ..models.task_matter import TaskMatter
    from ..models.task_task_type import TaskTaskType
...
class Task:
    ...
    Attributes:
        ...
        task_type (Union[Unset, TaskTaskType]):
        assigner (Union[Unset, TaskAssigner]):
        matter (Union[Unset, TaskMatter]):
        assignee (Union[Unset, TaskAssignee]):
    ...
    task_type: Union[Unset, "TaskTaskType"] = UNSET
    assigner: Union[Unset, "TaskAssigner"] = UNSET
    matter: Union[Unset, "TaskMatter"] = UNSET
    assignee: Union[Unset, "TaskAssignee"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_task_type, Unset):
            ...
            task_type = TaskTaskType.from_dict(_task_type)
        ...
        if isinstance(_assigner, Unset):
            ...
            assigner = TaskAssigner.from_dict(_assigner)
        ...
        if isinstance(_matter, Unset):
            ...
            matter = TaskMatter.from_dict(_matter)
        ...
        if isinstance(_assignee, Unset):
            ...
            assignee = TaskAssignee.from_dict(_assignee)
