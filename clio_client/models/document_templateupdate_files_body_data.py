...
class DocumentTemplateupdateFilesBodyData:
    ...
    document_category: Union[Unset, "DocumentTemplateupdateFilesBodyDataDocumentCategory"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_document_category, Unset):
            ...
            document_category = DocumentTemplateupdateFilesBodyDataDocumentCategory.from_dict(_document_category)
