...
class Report:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_state, Unset):
            ...
            state = check_report_base_state(_state)
        ...
        if isinstance(_kind, Unset):
            ...
            kind = check_report_base_kind(_kind)
        ...
        if isinstance(_format_, Unset):
            ...
            format_ = check_report_base_format(_format_)
        ...
        if isinstance(_category, Unset):
            ...
            category = check_report_base_category(_category)
        ...
        if isinstance(_source, Unset):
            ...
            source = check_report_base_source(_source)
