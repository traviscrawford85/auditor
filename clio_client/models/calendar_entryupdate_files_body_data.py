...
class CalendarEntryupdateFilesBodyData:
    """
    Attributes:
        deleted (Union[Unset, CalendarEntryupdateFilesBodyDataDeleted]): Flag to delete a specific instance of a
            recurring event.
    ...
    deleted: Union[Unset, CalendarEntryupdateFilesBodyDataDeleted] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deleted: Union[Unset, CalendarEntryupdateFilesBodyDataDeleted]
        if isinstance(_deleted, Unset):
            deleted = UNSET
        else:
            deleted = check_calendar_entryupdate_files_body_data_deleted(_deleted)
