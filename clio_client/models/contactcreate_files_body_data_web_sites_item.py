...
from ..models.contactcreate_files_body_data_web_sites_item_name import (
    ...
    check_contactcreate_files_body_data_web_sites_item_name,
)
...
class ContactcreateFilesBodyDataWebSitesItem:
    """
    Attributes:
        name (Union[Unset, ContactcreateFilesBodyDataWebSitesItemName]): Name of the WebSite. Default: 'Other'.
    ...
    name: Union[Unset, ContactcreateFilesBodyDataWebSitesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactcreate_files_body_data_web_sites_item_name(_name)
