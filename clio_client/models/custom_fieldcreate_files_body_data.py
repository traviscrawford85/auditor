...
class CustomFieldcreateFilesBodyData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        field_type = check_custom_fieldcreate_files_body_data_field_type(d.pop("field_type"))

        name = d.pop("name")

        parent_type = check_custom_fieldcreate_files_body_data_parent_type(d.pop("parent_type"))
