...
from ..models.matter_custom_rate_base_type import MatterCustomRateBaseType, check_matter_custom_rate_base_type
...
class MatterCustomRateBase:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_matter_custom_rate_base_type(_type_)
