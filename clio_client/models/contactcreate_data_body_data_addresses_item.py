...
from ..models.contactcreate_data_body_data_addresses_item_name import (
    ...
    check_contactcreate_data_body_data_addresses_item_name,
)
...
class ContactcreateDataBodyDataAddressesItem:
    """
    Attributes:
        name (Union[Unset, ContactcreateDataBodyDataAddressesItemName]): Name of the Address. Default: 'Other'.
    ...
    name: Union[Unset, ContactcreateDataBodyDataAddressesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactcreate_data_body_data_addresses_item_name(_name)
