...
class ContactPaymentProfile:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_interest_type, Unset):
            ...
            interest_type = check_payment_profile_base_interest_type(_interest_type)

        contact_payment_profile = cls(
            id=id,
            etag=etag,
        ...
        contact_payment_profile.additional_properties = d
        return contact_payment_profile
