...
class MedicalRecordsRequestupdateDataBodyData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_bills_status, Unset):
            ...
            bills_status = check_medical_records_requestupdate_data_body_data_bills_status(_bills_status)
        ...
        if isinstance(_records_status, Unset):
            ...
            records_status = check_medical_records_requestupdate_data_body_data_records_status(_records_status)
