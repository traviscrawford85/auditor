...
from ..models.taskcreate_data_body_data_cascading_offset_polarity import (
    ...
    check_taskcreate_data_body_data_cascading_offset_polarity)
from ..models.taskcreate_data_body_data_cascading_offset_type import (
    TaskcreateDataBodyDataCascadingOffsetType,
    check_taskcreate_data_body_data_cascading_offset_type)
from ..models.taskcreate_data_body_data_permission import (
    TaskcreateDataBodyDataPermission,
    check_taskcreate_data_body_data_permission)
from ..models.taskcreate_data_body_data_priority import (
    TaskcreateDataBodyDataPriority, check_taskcreate_data_body_data_priority)
from ..models.taskcreate_data_body_data_status import (
    TaskcreateDataBodyDataStatus, check_taskcreate_data_body_data_status)
...
class TaskcreateDataBodyData:
    ...
    Attributes:
        ...
        permission (Union[Unset, TaskcreateDataBodyDataPermission]): Permission of the Task. Defaults to `public`
            Default: 'public'.
        priority (Union[Unset, TaskcreateDataBodyDataPriority]): Priority of the Task. Default: 'Normal'.
    ...
    permission: Union[Unset, TaskcreateDataBodyDataPermission] = "public"
    priority: Union[Unset, TaskcreateDataBodyDataPriority] = "Normal"
    status: Union[Unset, TaskcreateDataBodyDataStatus] = "pending"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cascading_offset_polarity, Unset):
            ...
            cascading_offset_polarity = check_taskcreate_data_body_data_cascading_offset_polarity(
        ...
        if isinstance(_cascading_offset_type, Unset):
            ...
            cascading_offset_type = check_taskcreate_data_body_data_cascading_offset_type(_cascading_offset_type)
        ...
        if isinstance(_permission, Unset):
            ...
            permission = check_taskcreate_data_body_data_permission(_permission)
        ...
        if isinstance(_priority, Unset):
            ...
            priority = check_taskcreate_data_body_data_priority(_priority)
        ...
        if isinstance(_status, Unset):
            ...
            status = check_taskcreate_data_body_data_status(_status)
