...
T = TypeVar("T", bound="PolymorphicRateGroup")


@_attrs_define
class PolymorphicRateGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        polymorphic_rate_group = cls(
            id=id,
            etag=etag,
            name=name,
        )

        polymorphic_rate_group.additional_properties = d
        return polymorphic_rate_group
