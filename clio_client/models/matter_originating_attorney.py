...
T = TypeVar("T", bound="MatterOriginatingAttorney")


@_attrs_define
class MatterOriginatingAttorney:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_originating_attorney = cls(
        ...
        matter_originating_attorney.additional_properties = d
        return matter_originating_attorney
