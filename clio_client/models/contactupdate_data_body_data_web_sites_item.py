...
from ..models.contactupdate_data_body_data_web_sites_item_name import (
    ...
    check_contactupdate_data_body_data_web_sites_item_name)
...
class ContactupdateDataBodyDataWebSitesItem:
    """
    Attributes:
        name (Union[Unset, ContactupdateDataBodyDataWebSitesItemName]): Name of the WebSite. Default: 'Other'.
    ...
    name: Union[Unset, ContactupdateDataBodyDataWebSitesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactupdate_data_body_data_web_sites_item_name(_name)
