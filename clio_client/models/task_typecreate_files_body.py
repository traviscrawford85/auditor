...
@_attrs_define
class TaskTypecreateFilesBody:
    """
    Attributes:
        data (TaskTypecreateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task_typecreate_files_body = cls(
            data=data,
        )

        task_typecreate_files_body.additional_properties = d
        return task_typecreate_files_body
