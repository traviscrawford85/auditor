...
T = TypeVar("T", bound="UserDefaultActivityDescription")


@_attrs_define
class UserDefaultActivityDescription:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_default_activity_description = cls(
            id=id,
            etag=etag,
            name=name,
        ...
        user_default_activity_description.additional_properties = d
        return user_default_activity_description
