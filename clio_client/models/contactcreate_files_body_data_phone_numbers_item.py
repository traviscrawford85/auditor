...
from ..models.contactcreate_files_body_data_phone_numbers_item_name import (
    ...
    check_contactcreate_files_body_data_phone_numbers_item_name)
...
class ContactcreateFilesBodyDataPhoneNumbersItem:
    """
    Attributes:
        name (Union[Unset, ContactcreateFilesBodyDataPhoneNumbersItemName]): Name of the PhoneNumber. Default: 'Other'.
    ...
    name: Union[Unset, ContactcreateFilesBodyDataPhoneNumbersItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactcreate_files_body_data_phone_numbers_item_name(_name)
