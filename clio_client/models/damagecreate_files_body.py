...
T = TypeVar("T", bound="DamagecreateFilesBody")


@_attrs_define
class DamagecreateFilesBody:
    """
    Attributes:
        data (DamagecreateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        damagecreate_files_body = cls(
            data=data,
        )

        damagecreate_files_body.additional_properties = d
        return damagecreate_files_body
