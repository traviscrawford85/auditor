...
T = TypeVar("T", bound="GrantcreateFilesBody")


@_attrs_define
class GrantcreateFilesBody:
    """
    Attributes:
        data (GrantcreateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grantcreate_files_body = cls(
            data=data,
        )

        grantcreate_files_body.additional_properties = d
        return grantcreate_files_body
