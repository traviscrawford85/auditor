...
from ..models.calendar_entrycreate_json_body_data_deleted import (
    ...
    check_calendar_entrycreate_json_body_data_deleted,
)
...
class CalendarEntrycreateJsonBodyData:
    ...
    Attributes:
        ...
        deleted (Union[Unset, CalendarEntrycreateJsonBodyDataDeleted]): Flag to delete a specific instance of a
            recurring event.
    ...
    summary: str
    deleted: Union[Unset, CalendarEntrycreateJsonBodyDataDeleted] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deleted: Union[Unset, CalendarEntrycreateJsonBodyDataDeleted]
        if isinstance(_deleted, Unset):
            deleted = UNSET
        else:
            deleted = check_calendar_entrycreate_json_body_data_deleted(_deleted)
