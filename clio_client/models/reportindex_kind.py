...
REPORTINDEX_KIND_VALUES: set[ReportindexKind] = {
    "accounts_receivable",
    "accounts_receivable_aging",
    "bank_account_activity",
    "billing_history",
...
def check_reportindex_kind(value: str) -> ReportindexKind:
    if value in REPORTINDEX_KIND_VALUES:
        return cast(ReportindexKind, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {REPORTINDEX_KIND_VALUES!r}")
