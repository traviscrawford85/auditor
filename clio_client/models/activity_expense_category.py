...
T = TypeVar("T", bound="ActivityExpenseCategory")


@_attrs_define
class ActivityExpenseCategory:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_expense_category.additional_properties = d
        return activity_expense_category
