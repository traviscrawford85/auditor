...
class TaskupdateJsonBodyData:
    ...
    Attributes:
        ...
        permission (Union[Unset, TaskupdateJsonBodyDataPermission]): Permission of the Task. Defaults to `public`
            Default: 'public'.
        priority (Union[Unset, TaskupdateJsonBodyDataPriority]): Priority of the Task. Default: 'Normal'.
    ...
    permission: Union[Unset, TaskupdateJsonBodyDataPermission] = "public"
    priority: Union[Unset, TaskupdateJsonBodyDataPriority] = "Normal"
    status: Union[Unset, TaskupdateJsonBodyDataStatus] = "pending"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cascading_offset_polarity, Unset):
            ...
            cascading_offset_polarity = check_taskupdate_json_body_data_cascading_offset_polarity(
        ...
        if isinstance(_cascading_offset_type, Unset):
            ...
            cascading_offset_type = check_taskupdate_json_body_data_cascading_offset_type(_cascading_offset_type)
        ...
        if isinstance(_permission, Unset):
            ...
            permission = check_taskupdate_json_body_data_permission(_permission)
        ...
        if isinstance(_priority, Unset):
            ...
            priority = check_taskupdate_json_body_data_priority(_priority)
        ...
        if isinstance(_status, Unset):
            ...
            status = check_taskupdate_json_body_data_status(_status)
