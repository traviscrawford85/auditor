...
T = TypeVar("T", bound="FoldercreateFilesBody")


@_attrs_define
class FoldercreateFilesBody:
    """
    Attributes:
        data (FoldercreateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        foldercreate_files_body = cls(
            data=data,
        )

        foldercreate_files_body.additional_properties = d
        return foldercreate_files_body
