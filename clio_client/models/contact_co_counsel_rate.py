...
T = TypeVar("T", bound="ContactCoCounselRate")


@_attrs_define
class ContactCoCounselRate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact_co_counsel_rate.additional_properties = d
        return contact_co_counsel_rate
