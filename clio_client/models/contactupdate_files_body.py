...
@_attrs_define
class ContactupdateFilesBody:
    """
    Attributes:
        data (ContactupdateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contactupdate_files_body = cls(
            data=data,
        )

        contactupdate_files_body.additional_properties = d
        return contactupdate_files_body
