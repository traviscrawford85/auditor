...
if TYPE_CHECKING:
    ...
    from ..models.matter_contingency_fee import MatterContingencyFee
    from ..models.matter_custom_rate import MatterCustomRate
    from ..models.matter_evergreen_retainer import MatterEvergreenRetainer
    from ..models.matter_folder import MatterFolder
    from ..models.matter_group import MatterGroup
...
class Matter:
    ...
    Attributes:
        ...
        matter_stage_updated_at (Union[Unset, datetime.datetime]): The date the matter stage was last updated (as a
            ISO-8601 date)
        client (Union[Unset, MatterClient]):
        contingency_fee (Union[Unset, MatterContingencyFee]):
        custom_rate (Union[Unset, MatterCustomRate]):
        evergreen_retainer (Union[Unset, MatterEvergreenRetainer]):
        folder (Union[Unset, MatterFolder]):
        group (Union[Unset, MatterGroup]):
        matter_budget (Union[Unset, MatterMatterBudget]):
        matter_stage (Union[Unset, MatterMatterStage]):
        originating_attorney (Union[Unset, MatterOriginatingAttorney]):
        practice_area (Union[Unset, MatterPracticeArea]):
        responsible_attorney (Union[Unset, MatterResponsibleAttorney]):
        statute_of_limitations (Union[Unset, MatterStatuteOfLimitations]):
        user (Union[Unset, MatterUser]):
        legal_aid_uk_matter (Union[Unset, MatterLegalAidUkMatter]):
    ...
    client: Union[Unset, "MatterClient"] = UNSET
    contingency_fee: Union[Unset, "MatterContingencyFee"] = UNSET
    custom_rate: Union[Unset, "MatterCustomRate"] = UNSET
    evergreen_retainer: Union[Unset, "MatterEvergreenRetainer"] = UNSET
    folder: Union[Unset, "MatterFolder"] = UNSET
    group: Union[Unset, "MatterGroup"] = UNSET
    matter_budget: Union[Unset, "MatterMatterBudget"] = UNSET
    matter_stage: Union[Unset, "MatterMatterStage"] = UNSET
    originating_attorney: Union[Unset, "MatterOriginatingAttorney"] = UNSET
    practice_area: Union[Unset, "MatterPracticeArea"] = UNSET
    responsible_attorney: Union[Unset, "MatterResponsibleAttorney"] = UNSET
    statute_of_limitations: Union[Unset, "MatterStatuteOfLimitations"] = UNSET
    user: Union[Unset, "MatterUser"] = UNSET
    legal_aid_uk_matter: Union[Unset, "MatterLegalAidUkMatter"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = check_matter_base_status(_status)
        ...
        if isinstance(_billing_method, Unset):
            ...
            billing_method = check_matter_base_billing_method(_billing_method)
        ...
        if isinstance(_client, Unset):
            ...
            client = MatterClient.from_dict(_client)
        ...
        if isinstance(_contingency_fee, Unset):
            ...
            contingency_fee = MatterContingencyFee.from_dict(_contingency_fee)
        ...
        if isinstance(_evergreen_retainer, Unset):
            ...
            evergreen_retainer = MatterEvergreenRetainer.from_dict(_evergreen_retainer)
        ...
        if isinstance(_folder, Unset):
            ...
            folder = MatterFolder.from_dict(_folder)
        ...
        if isinstance(_group, Unset):
            ...
            group = MatterGroup.from_dict(_group)
        ...
        if isinstance(_matter_budget, Unset):
            ...
            matter_budget = MatterMatterBudget.from_dict(_matter_budget)
        ...
        if isinstance(_matter_stage, Unset):
            ...
            matter_stage = MatterMatterStage.from_dict(_matter_stage)
        ...
        if isinstance(_originating_attorney, Unset):
            ...
            originating_attorney = MatterOriginatingAttorney.from_dict(_originating_attorney)
        ...
        if isinstance(_practice_area, Unset):
            ...
            practice_area = MatterPracticeArea.from_dict(_practice_area)
        ...
        if isinstance(_responsible_attorney, Unset):
            ...
            responsible_attorney = MatterResponsibleAttorney.from_dict(_responsible_attorney)
        ...
        if isinstance(_statute_of_limitations, Unset):
            ...
            statute_of_limitations = MatterStatuteOfLimitations.from_dict(_statute_of_limitations)
        ...
        if isinstance(_user, Unset):
            ...
            user = MatterUser.from_dict(_user)
        ...
        if isinstance(_legal_aid_uk_matter, Unset):
            ...
            legal_aid_uk_matter = MatterLegalAidUkMatter.from_dict(_legal_aid_uk_matter)
