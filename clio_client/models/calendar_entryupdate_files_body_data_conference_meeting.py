...
from ..models.calendar_entryupdate_files_body_data_conference_meeting_type import (
    ...
    check_calendar_entryupdate_files_body_data_conference_meeting_type)
...
class CalendarEntryupdateFilesBodyDataConferenceMeeting:
    ...
    type_: Union[Unset, CalendarEntryupdateFilesBodyDataConferenceMeetingType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, CalendarEntryupdateFilesBodyDataConferenceMeetingType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = check_calendar_entryupdate_files_body_data_conference_meeting_type(_type_)
