...
from ..models.utbms_code_base_type import UtbmsCodeBaseType, check_utbms_code_base_type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ActivityUtbmsExpense")


@_attrs_define
class ActivityUtbmsExpense:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_utbms_code_base_type(_type_)
        ...
        activity_utbms_expense.additional_properties = d
        return activity_utbms_expense
