...
class ContactupdateFilesBodyDataWebSitesItem:
    """
    Attributes:
        name (Union[Unset, ContactupdateFilesBodyDataWebSitesItemName]): Name of the WebSite. Default: 'Other'.
    ...
    name: Union[Unset, ContactupdateFilesBodyDataWebSitesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactupdate_files_body_data_web_sites_item_name(_name)
