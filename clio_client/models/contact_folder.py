...
from ..models.folder_base_type import FolderBaseType, check_folder_base_type
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactFolder")
...
class ContactFolder:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_folder_base_type(_type_)
        ...
        contact_folder.additional_properties = d
