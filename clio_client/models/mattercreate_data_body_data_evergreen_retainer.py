...
class MattercreateDataBodyDataEvergreenRetainer:
    ...
    recipients: Union[Unset, list["MattercreateDataBodyDataEvergreenRetainerRecipientsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for recipients_item_data in _recipients or []:
            recipients_item = MattercreateDataBodyDataEvergreenRetainerRecipientsItem.from_dict(recipients_item_data)
