...
T = TypeVar("T", bound="MatterContingencyFee")


@_attrs_define
class MatterContingencyFee:
    """
    Attributes:
        id (Union[Unset, int]): Unique identifier for the *ContingencyFee*
        etag (Union[Unset, str]): ETag for the *ContingencyFee*
        created_at (Union[Unset, datetime.datetime]): The time the *ContingencyFee* was created (as a ISO-8601
            timestamp)
        updated_at (Union[Unset, datetime.datetime]): The time the *ContingencyFee* was last updated (as a ISO-8601
            timestamp)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matter_contingency_fee.additional_properties = d
        return matter_contingency_fee
