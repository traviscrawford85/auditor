...
ReportPresetcreateJsonBodyDataKind = Literal[
    "accounts_receivable",
...
REPORT_PRESETCREATE_JSON_BODY_DATA_KIND_VALUES: set[ReportPresetcreateJsonBodyDataKind] = {
    "accounts_receivable",
    "accounts_receivable_aging",
    "bank_account_activity",
    "billing_history",
...
def check_report_presetcreate_json_body_data_kind(value: str) -> ReportPresetcreateJsonBodyDataKind:
    if value in REPORT_PRESETCREATE_JSON_BODY_DATA_KIND_VALUES:
        return cast(ReportPresetcreateJsonBodyDataKind, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {REPORT_PRESETCREATE_JSON_BODY_DATA_KIND_VALUES!r}")
