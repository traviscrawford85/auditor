...
T = TypeVar("T", bound="ActivityActivityDescription")


@_attrs_define
class ActivityActivityDescription:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        activity_activity_description = cls(
            id=id,
            etag=etag,
            name=name,
        ...
        activity_activity_description.additional_properties = d
        return activity_activity_description
