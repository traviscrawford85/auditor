...
from ..models.task_templatecreate_files_body_data_reminder_templates_item_notification_type import (
    ...
    check_task_templatecreate_files_body_data_reminder_templates_item_notification_type)
...
class TaskTemplatecreateFilesBodyDataReminderTemplatesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        notification_type = check_task_templatecreate_files_body_data_reminder_templates_item_notification_type(
