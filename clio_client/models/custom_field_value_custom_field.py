...
if TYPE_CHECKING:
    from ..models.picklist_option_base import PicklistOptionBase


T = TypeVar("T", bound="CustomFieldValueCustomField")


@_attrs_define
class CustomFieldValueCustomField:
    """
    Attributes:
        ...
        picklist_options (Union[Unset, list['PicklistOptionBase']]): PicklistOption
    """
    ...
    picklist_options: Union[Unset, list["PicklistOptionBase"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_parent_type, Unset):
            ...
            parent_type = check_custom_field_base_parent_type(_parent_type)
        ...
        if isinstance(_field_type, Unset):
            ...
            field_type = check_custom_field_base_field_type(_field_type)
        ...
        for picklist_options_item_data in _picklist_options or []:
            picklist_options_item = PicklistOptionBase.from_dict(picklist_options_item_data)

            picklist_options.append(picklist_options_item)

        custom_field_value_custom_field = cls(
            id=id,
            etag=etag,
        ...
        custom_field_value_custom_field.additional_properties = d
        return custom_field_value_custom_field
