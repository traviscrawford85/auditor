...
PracticeAreaBaseCategory = Literal[
    "administrative",
...
PRACTICE_AREA_BASE_CATEGORY_VALUES: set[PracticeAreaBaseCategory] = {
    "administrative",
    "admiralty_and_maritime",
    "anti_trust_and_competition",
    "appellate",
...
def check_practice_area_base_category(value: str) -> PracticeAreaBaseCategory:
    if value in PRACTICE_AREA_BASE_CATEGORY_VALUES:
        return cast(PracticeAreaBaseCategory, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {PRACTICE_AREA_BASE_CATEGORY_VALUES!r}")
