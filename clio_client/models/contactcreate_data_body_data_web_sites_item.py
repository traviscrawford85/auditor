...
from ..models.contactcreate_data_body_data_web_sites_item_name import (
    ...
    check_contactcreate_data_body_data_web_sites_item_name,
)
...
class ContactcreateDataBodyDataWebSitesItem:
    """
    Attributes:
        name (Union[Unset, ContactcreateDataBodyDataWebSitesItemName]): Name of the WebSite. Default: 'Other'.
    ...
    name: Union[Unset, ContactcreateDataBodyDataWebSitesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactcreate_data_body_data_web_sites_item_name(_name)
