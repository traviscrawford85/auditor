...
class CalendarEntrycreateDataBodyData:
    ...
    Attributes:
        ...
        deleted (Union[Unset, CalendarEntrycreateDataBodyDataDeleted]): Flag to delete a specific instance of a
            recurring event.
    ...
    summary: str
    deleted: Union[Unset, CalendarEntrycreateDataBodyDataDeleted] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deleted: Union[Unset, CalendarEntrycreateDataBodyDataDeleted]
        if isinstance(_deleted, Unset):
            deleted = UNSET
        else:
            deleted = check_calendar_entrycreate_data_body_data_deleted(_deleted)
