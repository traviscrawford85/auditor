...
class DocumentTemplatecreateFilesBodyData:
    ...
    file: str
    document_category: Union[Unset, "DocumentTemplatecreateFilesBodyDataDocumentCategory"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_document_category, Unset):
            ...
            document_category = DocumentTemplatecreateFilesBodyDataDocumentCategory.from_dict(_document_category)
