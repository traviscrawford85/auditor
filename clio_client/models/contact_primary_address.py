...
T = TypeVar("T", bound="ContactPrimaryAddress")


@_attrs_define
class ContactPrimaryAddress:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact_primary_address.additional_properties = d
        return contact_primary_address
