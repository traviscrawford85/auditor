...
if TYPE_CHECKING:
    from ..models.calendar_creator import CalendarCreator
...
class Calendar:
    ...
    Attributes:
        ...
        creator (Union[Unset, CalendarCreator]):
    """
    ...
    creator: Union[Unset, "CalendarCreator"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_color, Unset):
            ...
            color = check_calendar_base_color(_color)
        ...
        if isinstance(_light_color, Unset):
            ...
            light_color = check_calendar_base_light_color(_light_color)
        ...
        if isinstance(_permission, Unset):
            ...
            permission = check_calendar_base_permission(_permission)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_calendar_base_type(_type_)
        ...
        if isinstance(_source, Unset):
            ...
            source = check_calendar_base_source(_source)
        ...
        if isinstance(_creator, Unset):
            ...
            creator = CalendarCreator.from_dict(_creator)
