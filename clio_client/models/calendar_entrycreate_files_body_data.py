...
class CalendarEntrycreateFilesBodyData:
    ...
    Attributes:
        ...
        deleted (Union[Unset, CalendarEntrycreateFilesBodyDataDeleted]): Flag to delete a specific instance of a
            recurring event.
    ...
    summary: str
    deleted: Union[Unset, CalendarEntrycreateFilesBodyDataDeleted] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deleted: Union[Unset, CalendarEntrycreateFilesBodyDataDeleted]
        if isinstance(_deleted, Unset):
            deleted = UNSET
        else:
            deleted = check_calendar_entrycreate_files_body_data_deleted(_deleted)
