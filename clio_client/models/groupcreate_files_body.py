...
T = TypeVar("T", bound="GroupcreateFilesBody")


@_attrs_define
class GroupcreateFilesBody:
    """
    Attributes:
        data (GroupcreateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        groupcreate_files_body = cls(
            data=data,
        )

        groupcreate_files_body.additional_properties = d
        return groupcreate_files_body
