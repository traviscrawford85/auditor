...
T = TypeVar("T", bound="ActivityCommunication")
...
class ActivityCommunication:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_communication_base_type(_type_)
        ...
        activity_communication.additional_properties = d
        return activity_communication
