...
from ..models.taskupdate_files_body_data_cascading_offset_polarity import (
    ...
    check_taskupdate_files_body_data_cascading_offset_polarity,
)
from ..models.taskupdate_files_body_data_cascading_offset_type import (
    TaskupdateFilesBodyDataCascadingOffsetType,
    check_taskupdate_files_body_data_cascading_offset_type,
)
from ..models.taskupdate_files_body_data_permission import (
    TaskupdateFilesBodyDataPermission,
    check_taskupdate_files_body_data_permission,
)
from ..models.taskupdate_files_body_data_priority import (
    TaskupdateFilesBodyDataPriority,
    check_taskupdate_files_body_data_priority,
)
from ..models.taskupdate_files_body_data_status import (
    TaskupdateFilesBodyDataStatus,
    check_taskupdate_files_body_data_status,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.taskupdate_files_body_data_assignee import TaskupdateFilesBodyDataAssignee
    from ..models.taskupdate_files_body_data_matter import TaskupdateFilesBodyDataMatter
    from ..models.taskupdate_files_body_data_task_type import TaskupdateFilesBodyDataTaskType
...
class TaskupdateFilesBodyData:
    ...
    Attributes:
        ...
        permission (Union[Unset, TaskupdateFilesBodyDataPermission]): Permission of the Task. Defaults to `public`
            Default: 'public'.
        priority (Union[Unset, TaskupdateFilesBodyDataPriority]): Priority of the Task. Default: 'Normal'.
        status (Union[Unset, TaskupdateFilesBodyDataStatus]): Task status. Users without advanced tasks are allowed to
            select `Complete` or `Pending` only. Default: 'pending'.
    ...
    permission: Union[Unset, TaskupdateFilesBodyDataPermission] = "public"
    priority: Union[Unset, TaskupdateFilesBodyDataPriority] = "Normal"
    status: Union[Unset, TaskupdateFilesBodyDataStatus] = "pending"
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.cascading_offset_polarity, Unset):
            cascading_offset_polarity = self.cascading_offset_polarity

        cascading_offset_type: Union[Unset, str] = UNSET
        if not isinstance(self.cascading_offset_type, Unset):
            cascading_offset_type = self.cascading_offset_type
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cascading_offset_polarity, Unset):
            ...
            cascading_offset_polarity = check_taskupdate_files_body_data_cascading_offset_polarity(
        ...
        if isinstance(_cascading_offset_type, Unset):
            ...
            cascading_offset_type = check_taskupdate_files_body_data_cascading_offset_type(_cascading_offset_type)
        ...
        if isinstance(_permission, Unset):
            ...
            permission = check_taskupdate_files_body_data_permission(_permission)
        ...
        if isinstance(_priority, Unset):
            ...
            priority = check_taskupdate_files_body_data_priority(_priority)
        ...
        if isinstance(_status, Unset):
            ...
            status = check_taskupdate_files_body_data_status(_status)
