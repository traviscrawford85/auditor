...
if TYPE_CHECKING:
    from ..models.webhook_user import WebhookUser
...
class Webhook:
    ...
    user: Union[Unset, "WebhookUser"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_model, Unset):
            ...
            model = check_webhook_base_model(_model)
        ...
        if isinstance(_status, Unset):
            ...
            status = check_webhook_base_status(_status)

        events = []
        _events = d.pop("events", UNSET)
        for events_item_data in _events or []:
            events_item = check_webhook_base_events_item(events_item_data)
        ...
        if isinstance(_user, Unset):
            ...
            user = WebhookUser.from_dict(_user)
