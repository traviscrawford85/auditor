...
class CustomFieldupdateFilesBodyData:
    ...
    picklist_options: Union[Unset, list["CustomFieldupdateFilesBodyDataPicklistOptionsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for picklist_options_item_data in _picklist_options or []:
            picklist_options_item = CustomFieldupdateFilesBodyDataPicklistOptionsItem.from_dict(
