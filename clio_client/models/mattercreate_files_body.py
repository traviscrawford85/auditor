...
T = TypeVar("T", bound="MattercreateFilesBody")


@_attrs_define
class MattercreateFilesBody:
    """
    Attributes:
        data (MattercreateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mattercreate_files_body = cls(
            data=data,
        )

        mattercreate_files_body.additional_properties = d
        return mattercreate_files_body
