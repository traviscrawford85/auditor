...
class MedicalRecordsRequestBase:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_bills_status, Unset):
            ...
            bills_status = check_medical_records_request_base_bills_status(_bills_status)
        ...
        if isinstance(_records_status, Unset):
            ...
            records_status = check_medical_records_request_base_records_status(_records_status)
