...
from ..models.contactupdate_data_body_data_email_addresses_item_name import (
    ...
    check_contactupdate_data_body_data_email_addresses_item_name,
)
...
class ContactupdateDataBodyDataEmailAddressesItem:
    ...
    name: Union[Unset, ContactupdateDataBodyDataEmailAddressesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactupdate_data_body_data_email_addresses_item_name(_name)
