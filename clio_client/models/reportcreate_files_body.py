...
T = TypeVar("T", bound="ReportcreateFilesBody")


@_attrs_define
class ReportcreateFilesBody:
    """
    Attributes:
        data (ReportcreateFilesBodyData):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reportcreate_files_body = cls(
            data=data,
        )

        reportcreate_files_body.additional_properties = d
        return reportcreate_files_body
