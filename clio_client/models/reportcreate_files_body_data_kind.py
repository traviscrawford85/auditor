...
ReportcreateFilesBodyDataKind = Literal[
    "accounts_receivable",
...
REPORTCREATE_FILES_BODY_DATA_KIND_VALUES: set[ReportcreateFilesBodyDataKind] = {
    "accounts_receivable",
    "accounts_receivable_aging",
    "bank_account_activity",
    "billing_history",
...
def check_reportcreate_files_body_data_kind(value: str) -> ReportcreateFilesBodyDataKind:
    if value in REPORTCREATE_FILES_BODY_DATA_KIND_VALUES:
        return cast(ReportcreateFilesBodyDataKind, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {REPORTCREATE_FILES_BODY_DATA_KIND_VALUES!r}")
