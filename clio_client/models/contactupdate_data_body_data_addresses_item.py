...
from ..models.contactupdate_data_body_data_addresses_item_name import (
    ...
    check_contactupdate_data_body_data_addresses_item_name,
)
...
class ContactupdateDataBodyDataAddressesItem:
    """
    Attributes:
        name (Union[Unset, ContactupdateDataBodyDataAddressesItemName]): Name of the Address. Default: 'Other'.
    ...
    name: Union[Unset, ContactupdateDataBodyDataAddressesItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactupdate_data_body_data_addresses_item_name(_name)
