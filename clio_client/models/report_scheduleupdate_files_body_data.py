...
class ReportScheduleupdateFilesBodyData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_frequency, Unset):
            ...
            frequency = check_report_scheduleupdate_files_body_data_frequency(_frequency)
        ...
        if isinstance(_time_zone, Unset):
            ...
            time_zone = check_report_scheduleupdate_files_body_data_time_zone(_time_zone)
