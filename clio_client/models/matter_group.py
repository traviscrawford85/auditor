...
from ..models.group_base_type import GroupBaseType, check_group_base_type
from ..types import UNSET, Unset

T = TypeVar("T", bound="MatterGroup")
...
class MatterGroup:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_group_base_type(_type_)
        ...
        matter_group.additional_properties = d
        return matter_group
