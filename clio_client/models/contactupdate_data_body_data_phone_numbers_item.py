...
from ..models.contactupdate_data_body_data_phone_numbers_item_name import (
    ...
    check_contactupdate_data_body_data_phone_numbers_item_name)
...
class ContactupdateDataBodyDataPhoneNumbersItem:
    """
    Attributes:
        name (Union[Unset, ContactupdateDataBodyDataPhoneNumbersItemName]): Name of the PhoneNumber. Default: 'Other'.
    ...
    name: Union[Unset, ContactupdateDataBodyDataPhoneNumbersItemName] = "Other"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = check_contactupdate_data_body_data_phone_numbers_item_name(_name)
