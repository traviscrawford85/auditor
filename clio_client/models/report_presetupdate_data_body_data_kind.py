...
ReportPresetupdateDataBodyDataKind = Literal[
    "accounts_receivable",
...
REPORT_PRESETUPDATE_DATA_BODY_DATA_KIND_VALUES: set[ReportPresetupdateDataBodyDataKind] = {
    "accounts_receivable",
    "accounts_receivable_aging",
    "bank_account_activity",
    "billing_history",
...
def check_report_presetupdate_data_body_data_kind(value: str) -> ReportPresetupdateDataBodyDataKind:
    if value in REPORT_PRESETUPDATE_DATA_BODY_DATA_KIND_VALUES:
        return cast(ReportPresetupdateDataBodyDataKind, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {REPORT_PRESETUPDATE_DATA_BODY_DATA_KIND_VALUES!r}")
