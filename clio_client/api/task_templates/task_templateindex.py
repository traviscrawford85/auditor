...
from ...models.task_template_list_response import TaskTemplateListResponse
...
) -> Optional[Union[Error, TaskTemplateListResponse]]:
    if response.status_code == 200:
        response_200 = TaskTemplateListResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, TaskTemplateListResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Error, TaskTemplateListResponse]
    """
