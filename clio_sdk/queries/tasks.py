"""
This file defines the queries interface for reading and listing task-related data from Clio.
...
def get_pending_tasks() -> list[Task]:
    ...
    if resp.status_code == 200 and resp.parsed:
        return [from_taskshow(t) for t in resp.parsed.tasks if t.status and t.status.value == "pending"]
    return []
